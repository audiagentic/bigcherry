...
_SWITCH_FUSION_FALSE_NEW = (
    ...
    "        (uint32_t) ncols_x, nchannels_y_fd, (uint32_t) stride_row_x, (uint32_t) stride_col_y,\n"
...
_GATE_ANCHOR_NEW = (
    ...
    "                static std::once_flag rd33_logged[9];\n"
    "                std::call_once(rd33_logged[ne1], [n = (int) ne1] {\n"
    "                    GGML_LOG_WARN(\"BIGCHERRY_PATCH_HIT patch=1241_rd33 path=q8_0_f32_decode ncols=%d\\n\", n);\n"
    "                });\n"
    "            }\n"
    "            const auto rd33_launch = [&](auto ncols) {\n"
    "                ggml_cuda_mmvq_q8_0_f32_decode<decltype(ncols)::value>(\n"
