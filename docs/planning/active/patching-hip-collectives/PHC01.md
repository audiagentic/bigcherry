...
Qwen matrix is blocked at preflight; source/fit resolution and hardware execution remain.
...
successor-specs/patching-hip-collectives-hi140.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: HI138,HI85.
