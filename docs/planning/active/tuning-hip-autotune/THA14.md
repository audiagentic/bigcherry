...
Typed op_variant_id cleanup plus helper/test refactoring remains explicit post-HI163 work.
...
successor-specs/tuning-hip-autotune-hi164.md
...
Reference handling: Rewrite forward references (7); preserve historical references (0) on predecessor.
