...
Two-GPU evidence narrows the issue, but the GPU0/27B production-path mismatch and follow-up experiments remain unresolved.
...
successor-specs/tuning-hip-autotune-hi172.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: HI141,HI17,VA22.

Active dependencies: Frozen dependencies: none recorded.

Reference handling: Rewrite forward references (9); preserve historical references (3) on predecessor.
