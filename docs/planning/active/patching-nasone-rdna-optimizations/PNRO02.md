...
RD89 reconciliation records NRO02 within the nasone NRO set as pending; no implementation or terminal disposition is recorded.
...
successor-specs/patching-nasone-rdna-optimizations-nro02.md
