...
Frozen VA26 is an in-progress PQM-v1 implementation with multiple stated steps and acceptance gates still pending; it is not a completed matrix.
...
successor-specs/patching-validation-package-standard-va26.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: RD08,RD73,VA25.

Active dependencies: Frozen dependencies: RD08,VA25.
