...
The original diff port was invalidated by upstream MMQ redesign, but the item was re-scoped to a still-open table-driven redesign investigation.
...
successor-specs/patching-rdna-boost-experiments-rd28.md
