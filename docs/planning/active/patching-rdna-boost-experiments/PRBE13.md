...
Shared-expert output-chain fusion remains planning-only; exact-pattern, correctness, workspace, and performance acceptance are unfinished.
...
successor-specs/patching-rdna-boost-experiments-rd15.md
