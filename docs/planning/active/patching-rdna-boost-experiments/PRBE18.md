...
The SSM pre-scan fusion remains an unported Wave-2 candidate dependent on RD09/bake-in correctness state.
...
successor-specs/patching-rdna-boost-experiments-rd24.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: RD14,RD16.

Active dependencies: Frozen dependencies: none recorded.

Reference handling: Rewrite forward references (3); preserve historical references (2) on predecessor.
