...
hipBLASLt vendor_auto route and correctness/force acceptance are pending.
...
successor-specs/tuning-rocm-vulkan-provider-ro09.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: none extracted.

Active dependencies: Frozen dependencies: RO10.
