...
Exhaustive raw-HIP kernel audit/disposition artifact is pending.
...
successor-specs/tuning-rocm-vulkan-provider-ro12.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: none extracted.

Active dependencies: Frozen dependencies: RO11.
