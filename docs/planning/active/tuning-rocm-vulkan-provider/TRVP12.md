...
Generic Vulkan runtime/candidate lifecycle integration is pending.
...
Reference handling: Rewrite forward references (8); preserve historical references (0) on predecessor.
