...
The provider-integration follow-up remains active and has no completed acceptance/retirement evidence in current lineage.
...
successor-specs/tuning-rocm-vulkan-provider-ro22.md
