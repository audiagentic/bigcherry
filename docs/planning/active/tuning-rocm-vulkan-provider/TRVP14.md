...
CM1 force/telemetry/correctness implementation and acceptance remain unchecked.
...
successor-specs/tuning-rocm-vulkan-provider-ro21.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: none extracted.

Active dependencies: Frozen dependencies: RE30,RE32,RE36.
