...
Containment is done; candidate-level fault identity and root cause remain open.
...
successor-specs/patching-external-fixes-ex03.md

## Validation

Historical evidence and constraints: Preserve frozen notes/reviews/evidence on predecessor; IDs: HI60.
