...
def run(args: argparse.Namespace) -> int:
    ...
    # (The historical --run-rd73-contract probe-skip was retired with the
    # RD73 legacy compatibility retirement; RD73's activation now comes
    # from its producer via the generic path. The RD08
    # --run-rd08-contract probe-skip was likewise retired earlier; 1204's
    # activation comes from its producer.) The generic probe therefore
    # always runs on the legacy run() path.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="PVPS02: the generic paired-benchmark entry point for ANY patch whose "
             ...
             "eligibility -- never populates contract_promotions. Does NOT require "
