"""RD05 backend_reference orchestration tests -- hardware-free."""
...
class RunRd05ContractCorrectnessTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_within_tolerance_passes(self) -> None:
        ...
        self.assertTrue((run_dir / "artifacts" / "rd05-correctness.json").exists())
        self.assertEqual(
    ...
    def test_wrong_architecture_fails_closed_before_materialization(self) -> None:
        ...
        with self.assertRaises(vc.PatchCampaignError):
            vc.run_rd05_contract_correctness(
                base_revision="a" * 40,
                hip_path=Path("H:/hip"),
