...
from bigcherry.patch import lifecycle as patch_lifecycle # noqa: E402
...
class ComputeAllFilteredInputsTests(unittest.TestCase):
    ...
    def test_worst_build_state_wins_when_a_cluster_has_mixed_states(self):
        ...
        import bigcherry.patch.patchset as patchset_module
        ...
        try:
            ...
            import bigcherry.source.sources as sources_module
