...
from bigcherry.campaign.build import CampaignBuildError, materialize_source  # noqa: E402
from bigcherry.core.context import ProjectContext  # noqa: E402
from bigcherry.source.workspace import SourcePlan, WorkspaceError  # noqa: E402
...
class PatchSetIdentityPersistedTests(unittest.TestCase):
    ...
    def test_source_plan_for_real_lane_persists_patch_set_id_into_metadata(self):
        ...
        from bigcherry.patch import patchset as bc_patchset
        from bigcherry.campaign.build import _source_metadata_path
        from bigcherry.campaign.source import (materialization_plan_id,
    ...
    def test_two_sources_with_identical_bytes_but_different_logical_composition_do_not_alias(self):
        ...
        from bigcherry.core import config as campaign_config
        from bigcherry.patch import patchset as bc_patchset
        from bigcherry.campaign.source import source_plan_for
