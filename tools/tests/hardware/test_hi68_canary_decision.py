    ...
    def test_canary_decision_host_test(self):
        ...
        try:
            ...
            if build.returncode != 0:
                ...
                if "cmath" in compiler_output and "file not found" in compiler_output:
                    raise unittest.SkipTest(
                        "C++17 canary probe unavailable: selected compiler cannot "
                        "locate the standard C++ header <cmath>"
                    )
                self.fail(
